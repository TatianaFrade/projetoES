...
javac -encoding UTF-8 -cp "gson-2.10.1.jar;." -d "target\classes" src\main\java\pt\ipleiria\estg\ei\dei\esoft\*.java

echo Executando a aplicacao...
java -cp "target\classes;gson-2.10.1.jar" pt.ipleiria.estg.ei.dei.esoft.Main
